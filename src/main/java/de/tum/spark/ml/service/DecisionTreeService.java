...
//        double trainSplit = decisionTree.getDtTrainModel().getTraining_size();
//        double testSplit = decisionTree.getDtTrainModel().getTest_size();
//
...
//        inputOutputMapper = DecisionTreeTrainModel.getJavaCode(decisionTree.getDtTrainModel(), javaCodeGenerator, inputOutputMapper);
//
